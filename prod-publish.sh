...
ORG_ID="<mule_org_id>"
USER_ID="<mule_user_id>"

# Log directory and timestamp
LOG_DIR="/home/ec2-user/Mulesoft/logs"
TIMESTAMP=$(date +"%Y-%m-%d_%H-%M-%S")
LOG_FILE="${LOG_DIR}/prod-publish-job_${TIMESTAMP}.log"
...
nohup java -Dspring.config.additional-location=file:/home/ec2-user/Mulesoft/application-prod.yml -Dmanagement.server.port=8085 -jar /home/ec2-user/Mulesoft/integrations-mulesoft.jar >> "$LOG_FILE" 2>&1 &
